...
public class TestingParser {
    ...
    public static void main(String[] args) throws WrongFileException {
        ...
        System.out.println("No. of Bounces for property 5 : " + dataAnalytics.noOfBounces(slp.getServerLogs(), 5));
        ...
        System.out.println("Bounce Rate : " + dataAnalytics.bounceRate(clp.getClickLogs(), slp.getServerLogs(), 5).floatValue());
